import"./styles-B8WF9G-F.js";import{i as le,c as pe,r as ge,t as x,a as he,b as xe,d as me,g as ee}from"./nav-BKPoqOVV.js";const te=[{id:"h2",labelKey:"ladder.scenH2",descKey:"ladder.descH2",charge:0,mult:1,xyz:`2
H2
H  0.0  0.0  0.0
...
F2
F  0.0  0.0  0.0
F  0.0  0.0  1.412000`}],fe=["STO-3G","STO-6G","3-21G","6-31G","6-31G(d,p)","cc-pVDZ","aug-cc-pVDZ","def2-SVP","cc-pVTZ","def2-TZVP"],H=[{id:"HF",label:"HF",category:"Post-HF",type:"hf"},{id:"MP2",label:"MP2",category:"Post-HF",type:"postHF"},{id:"MP3",label:"MP3",category:"Post-HF",type:"postHF"},{id:"CCSD",label:"CCSD",category:"Post-HF",type:"postHF"},{id:"SVWN",label:"SVWN",category:"LDA",type:"dft",functional:"SVWN"},{id:"BLYP",label:"BLYP",category:"GGA",type:"dft",functional:"BLYP"},{id:"PBE",label:"PBE",category:"GGA",type:"dft",functional:"PBE"},{id:"B3LYP",label:"B3LYP",category:"Hybrid",type:"dft",functional:"B3LYP"}];let V=te[0],G="STO-3G",T=new Set(H.map(e=>e.id)),$=[],C=!1,K=!1,D=[],I=[],q=[],W=0,Y=null,X=0,O="none";const J=new Map;async function ue(e){const t=J.get(e);if(t)return t;const o=`/GANSU-Lite/basis/${e.toLowerCase()}.gbs`,r=await fetch(o);if(!r.ok)throw new Error(`Failed to load basis set: ${e}`);const n=await r.text();return J.set(e,n),n}const ye={HF:"#1f77b4",MP2:"#2ca02c",MP3:"#ff7f0e",CCSD:"#d62728",SVWN:"#9467bd",BLYP:"#8c564b",PBE:"#e377c2",B3LYP:"#17becf"},$e={HF:"#4dabf7",MP2:"#51cf66",MP3:"#ffa94d",CCSD:"#ff6b6b",SVWN:"#b197fc",BLYP:"#c4956a",PBE:"#f59fda",B3LYP:"#66d9e8"};function R(e){return me()?$e[e]??"#ccc":ye[e]??"#666"}function be(){re(),D=H.map(o=>T.has(o.id)?"pending":"skipped"),I=H.map(()=>0),q=H.map(o=>T.has(o.id)?"":"skipped"),X=performance.now(),W=0,O="none";const e=document.createElement("div");e.id="acc-progress-overlay",e.className="acc-prog-overlay";const t=document.createElement("div");t.className="acc-prog-modal",t.id="acc-progress-modal",e.appendChild(t),document.body.appendChild(e),Y=setInterval(()=>{W=performance.now()-X;const o=document.getElementById("acc-prog-elapsed");o&&(o.textContent=(W/1e3).toFixed(1)+"s")},200),j()}function j(){const e=document.getElementById("acc-progress-modal");if(!e)return;const o=(D.filter(s=>s==="done"||s==="skipped").length/H.length*100).toFixed(0),r=(W/1e3).toFixed(1),n=O==="wasm-simd"?"active":"inactive",d=O==="wasm"?"active":"inactive",c=O==="js"?"active":"inactive";let m=`
